...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxpZS1oYW5ub3VjaCIsImEiOiJja2tja3AzaGkwZnBqMnZxcjhmcXgxeDdlIn0.O56Oh9k4OrS_3KHPj46P4g';
...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, time * 2000);
};
...
exports.logoutAfterPasswordChange = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (document.title === 'Natours | Log into your account') (0, _alert.showAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Eroor logging out! try Again');
...
var logoutAfterPasswordChange = /*#__PURE__*/function () {
  ...
  return function logoutAfterPasswordChange() {
    return _ref3.apply(this, arguments);
  };
}();

exports.logoutAfterPasswordChange = logoutAfterPasswordChange;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Account created Successfully! Please check your email to verify your account');
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type[0].toUpperCase() + type.substring(1), " updated successfully!"));
              location.reload();
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your password is changed successfully. You will be logged out in 15 sec ');
              window.setTimeout(function () {
                (0, _login.logoutAfterPasswordChange)();
              }, 15000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./login":"login.js"}],"favorite.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51I5qGhI7fNLNv4uJMcx5dVfpME1mLVHE0NLbw8sEHMEcwbU7oC9Yly3a9x7DyT2i0N3fcxIrwRmzOuYaCuEQa86w00fTVF1BgQ');
            _context.prev = 1;
            _context.next = 4;
